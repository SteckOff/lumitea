...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final needsAuth = state.matchedLocation == '/checkout' || state.matchedLocation == '/orders';
    ...
    routes: [
      ShellRoute(
        ...
        routes: [
          GoRoute(path: '/', name: 'catalog', builder: (_, __) => const CatalogShellHome()),
          GoRoute(path: '/promotions', name: 'promotions', builder: (_, __) => const PromotionsPage()),
      ...
      GoRoute(
        path: '/product/:id',
        name: 'product',
        builder: (_, s) => ProductDetailPage(productId: int.parse(s.pathParameters['id']!)),
      ),
      GoRoute(path: '/checkout', name: 'checkout', builder: (_, __) => const CheckoutPage()),
      GoRoute(path: '/orders', name: 'orders', builder: (_, __) => const OrdersPage()),
